...
class About extends Component {
	...
	return (
		...
		<div className="habits about">
		    ...
		    <p> Double click on the habit to edit it. By default habits are saved in your browser, you can create an account to save them on the server and synchronize them across the devices.</p>
		    <p> If you are on mobile - open settings and click "Add to Home Screen", and helix will work like a native app. </p>
		    <hr/>
